	...
	class CR_All_Reviews
	{
		...
		*/
		...
		public function show_all_reviews()
		{
			...
			$return .= '<div id="cr_all_reviews_shortcode" class="cr-all-reviews-shortcode">';
			...
			public function show_summary_table()
			{
				...
				if ($all > 0) {
					...
					$output .= '<div class="cr-total-rating-count">' . sprintf( __( 'Based on %s reviews', 'customer-reviews-woocommerce' ), number_format_i18n( $all ) ) . '</div>';
					$output .= '</div>';
