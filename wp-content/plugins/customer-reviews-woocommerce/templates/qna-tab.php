...
$nonce_showmore = wp_create_nonce( "cr_qna_sm_" . $cr_product_id );
?>
<div id="cr_qna" class="cr-qna-block">
	...
	<div class="cr-qna-list-block">
		...
		if( isset( $qna ) && is_array( $qna ) && 0 < count( $qna ) ) :
			...
			?></div><?php
			?>
			<button id="cr-show-more-q-id" type="button" data-nonce="<?php echo $nonce_showmore; ?>" data-product="<?php echo $cr_product_id; ?>" data-page="0"<?php if( count( $qna ) >= $total_qna ) echo ' style="display:none"'; ?>><?php echo __( 'Show more', 'customer-reviews-woocommerce' ); ?></button>
