    ...
    protected function init_settings() {
      $this->settings = array(
        ...
        array(
            ...
            'type'  => 'title',
            'desc'  => sprintf( __( 'Specify mapping of WooCommerce product categories to Google Shopping product categories. The full list of Google Shopping product categories can be found %shere', 'customer-reviews-woocommerce' ), '<a href="' . plugins_url( $this->google_categories_path, __FILE__ ) . '" target="_blank">' ) .
              '</a><img src="' . untrailingslashit( plugin_dir_url( __FILE__ ) ) . '/img/external-link.png" class="cr-product-feed-categories-ext-icon">.',
            'id'    => 'cr_categories'
        ),
        array(
